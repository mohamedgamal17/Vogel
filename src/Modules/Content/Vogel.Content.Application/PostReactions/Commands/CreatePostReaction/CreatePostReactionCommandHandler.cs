...
namespace Vogel.Content.Application.PostReactions.Commands.CreatePostReaction
{
    public class CreatePostReactionCommandHandler : IApplicationRequestHandler<CreatePostReactionCommand, PostReactionDto>
    {
        ...
        public CreatePostReactionCommandHandler(ISocialRepository<PostReaction> postReactionRepository, ISocialRepository<Post> postRepository, IMongoRepository<PostReactionMongoEntity> postReactionMongoRepository, IPostReactionResponseFactory postReactionResponseFactory, ISecurityContext securityContext)
        {
